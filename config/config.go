...
func Load() Config {
	...
	config.ProjectName = cast.ToString(getOrReturnDefaultValue("PROJECT_NAME", "catalog_of_books"))
	...
	config.PostgresPassword = cast.ToString(getOrReturnDefaultValue("POSTGRES_PASSWORD", "sanjariut"))
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "catalog_of_books"))
